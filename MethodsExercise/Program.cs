...
class Program
{
    ...
    {
        Console.WriteLine("Everything within this story is purely fictional. This is a matured rated story. The best kind.");
        PauseAndClear();
...

        {
            ...
            Console.WriteLine($"This will be an epic story. One of danger and excitement. One of courage and fear. One of love and heartbreak.\nIt is great to have you here, {username}! I have been waiting for your arrival.\nAnd based on what I've been told,\nin perfect timing!.");
        ...
        {
            Console.WriteLine("It's just You and I here in this world, and because I fucking told you so...\nalso because it'll be fun!\nAnd if you disagree, I will come find you.");
...

        {
            ...
            Console.WriteLine($"Protagonist: {protagonist}\nFriend1: {friend1}\nFriend2: {friend2}\nAntagonist: {antagonist}");
            
            PauseAndClear();
          
            Console.WriteLine("That's that. I hope you thought really well on what you wanted, because there is no changing anything as of now.\nIf you thought so, well too fucking bad.\nYou'll have to go back and restart. If you do good luck and have fun!");
           
            PauseAndClear();
           
            Console.WriteLine($"Still here? Great! That means you have surpassed a nice percentage of our population in thinking. And commitment. Maybe both. I have one last question before I am to start this journey for us.\nKnow that I had enjoyed talking to and bullying you. What a time, right, {username}?\nI almost want to consider you as...");
...

        {
            ...
            Console.WriteLine($"Now, {username}, it is time for our finishing touch.\nI want you to name what our extra flavor in the story will be.\nWhat our protagonist and antagonist will use to aid their goals. And against one another...");
           
            PauseAndClear();
           
            Console.WriteLine($"{username}.What will be the name for this single object? The source of power. The tool. Relic.\nWhatever you decide it to be, it will make for an interesting read. And name it something original. Maybe even unexpecting.\nDon't just name it 'sword.' Get creative!\nType what this will be below:");
           
            string SoP = Console.ReadLine();
            
            ClearScreen();
            
            Console.WriteLine($"{username}! That is a lot better than what I have expected from you. You know what. I'm starting to like you. I will speak to you again in time. Let's fucking rock and roll, motherfucker!");
        ...
        static void Prologue_AshesOfTheOldWorld(string SoP)
        {
            ...
            Console.WriteLine("They called it the Sundering. Not a war of men and swords..\nbut of gods and fire, of truth split from lies.");
            
            PauseAndClear();
            
            Console.WriteLine($"Seven great {SoP}s were forged...powers not born,\nbut carved from the bones of creation. Those who wielded them rewrote history with\nevery breath.");
...

        {
            ...
            Console.WriteLine($"The wielders fell. Their {SoP}s lost.\nBuried. Forgotten. The world moved on,\nblind and broken");
...

        {
            ...
            Console.WriteLine("The ground trembles. The fire sputters. A pulse of violet light bursts from the woods...\nfollowed by silence.");
            ...
            Console.WriteLine($"Something calls to {protagonist}. It's not fear. It's not madness. It's familiar...\nlike when something lost is clawing its way home.");
        ...
        
        {
            ...
            Console.WriteLine($"It's midnight. The trio descends into the Hollow. Trees dead and black. The soil steams beneath {protagonist}'s boots.\nIn the center: a stone monolith, cracked open like an egg. And inside it, embedded in dark glass...\nThe {SoP}.");
            
            PauseAndClear();

            Console.WriteLine($"{protagonist} reaches for it. Time bends. Air hums. {protagonist}'s skin burns, but they do not pull away.\nThe moment their fingers touch it-everything changes.");
            
            PauseAndClear();
            
            Console.WriteLine($"(Flash of visions):\nFire, blood, a city crumbling. A face in the smoke...\nlaughing. A name echoes through {protagonist}'s mind. The one who carries a mark:\n{antagonist}.");
...

        {
            ...
            Console.WriteLine($"{protagonist} wakes near the campfire, gasping. The {SoP} is still in their hand. {friend1} stares at them as if they grew horns overnight.");
            ...
            Console.WriteLine($"Whatever {protagonist} saw..whatever {protagonist} felt..it's not over. It has only just begun.\nFrom the shadows, across the forest, something watches. And far to the East...\n{antagonist} awakens.");
        ...
        static void Chapter2_TheAwakening1(string protagonist,string friend1,string friend2,string antagonist,string SoP)

        {
            ...
            Console.WriteLine($"A towering obsidian keep looms over a scorched plain. Inside, a figure stirs in a chamber carved from volcanic stone.\nTheir eyes snap open...inhuman, burning with power. The {SoP} lies across their chest like a chained beast.\n{antagonist} has awakened.");
            ...
            Console.WriteLine($"{protagonist} returns to the Village of Silaris with their friends, {SoP} pulsing faintly beneath their cloak. The people of Silaris feel the change.\nSome step back as {protagonist} walks past. Others stare with haunted curiosity.");
...

        {
           ...
           Console.WriteLine("A violet storm swirls over the hills. Soldiers clad in black armor descend...beasts with eyes like mirrors among them.\nMagic and steel tear through the town. Civilians scream. Fire spreads.");
           ...
           Console.WriteLine($"{protagonist} bursts into the temple where a priest lies mortally wounded. He beckons {protagonist} to come closer, eyes wide with fear and awe.");
           
           PauseAndClear();
           
           Console.WriteLine($"Dying Priest:\n'' It was foretold...\nTwo flames. One born of light. One of ruin. You have lit one.\nAnd now, the other burns. ''");
...

        {
            ...
            Console.WriteLine($"{protagonist} and their two companions travel on foot along the dirt road, leaving the ruins of Silaris behind.\nThe wind is colder. The sky, duller.\n{protagonist}'s {SoP} hums against their back like a heartbeat one did not ask for.");
...

        {
            ...
            Console.WriteLine($"{protagonist} makes a camp nearby with the Hollowlight. Tension rises. Just before dawn, screams pierce the air. The Hollowlight camp is under attack.");
            ...
            Console.WriteLine($"The world slows. Heat pulses through {protagonist}'s chest. The {SoP} expands, transforming into its true form. Awakened in its response to danger.");
            
            PauseAndClear();
            
            Console.WriteLine($"{protagonist} strikes.\nNot with skill.\nNot with grace.\nBut with fury.\nWith fear.\nWith something older than blood.");
            
            PauseAndClear();
            
            Console.WriteLine($"When it's over, bodies lie strewn. The attackers are gone. {protagonist} stands in the glow of the {SoP} that hums with hunger.");
            ...
            Console.WriteLine($"{friend1}:(half laughing, half afraid)\n'' Whatever it was...I don't think it's done with you. ''");
...

        {
            ...
            Console.WriteLine($"{protagonist} sits by the fire, shaking. The Hollowlight bury their dead. One child watches {protagonist} from the dark...silent.\nUnblinking");
...

        {
            ...
            Console.WriteLine($"The trio climb through the jagged spines of the Sarnak Range. Ice bites at their faces. Hunger gnaws at their stomachs. The {SoP} has grown heavier with every mile...\nas if it knows what lies ahead.");
...

        {
            ...
            Console.WriteLine("Ash coats the streets. A lone figure waits at the central plaza, surrounded by burned bodies and shattered relics.\nThey wear no armor. No mask. But the power around them pulses like thunder.");
...

        {
            ...
            Console.WriteLine($"The Whisper vanishes in smoke. That night, a storm rises. {protagonist}'s fire dies fast. The trio argue louder than the wind.");
...

        {
            ...
            Console.WriteLine($"{protagonist} wakes up to {friend2} gone. No note. No sound. Just a cold trail down the mountain.");
        ...
        static void Chapter5_TheDescent1(string protagonist, string friend1, string friend2, string antagonist, string SoP)

        {
            ...
            Console.WriteLine($"It is now dusk. The world has stopped pretending to be kind. The skies are ash. The ground cracks beneath {protagonist} and {friend1}'s feet.\nFar in the distance, carved into the spine of the mountain, stands the enemy fortress-\nBlackspire.");
...

        {
            ...
            Console.WriteLine($"The two move through the fortress, which feels alive...walls pulsing, floors whispering. The voices of the past crawls up {protagonist}'s spine.\nAnd at the far end of the hall...\nwaits {friend2}.");
...

        {
            ...
            Console.WriteLine($"{friend2} carries out their own {SoP}. {protagonist} and {friend1} are in shock and disbelief. {protagonist} and {friend2} begin to clash, {friend2} initiating the first strike...\nboth of their {SoP}s screaming with every strike. {friend1} is blocked off by magical barriers but watches, torn between action and helplessness.");
...

        {
            ...
            Console.WriteLine($"{antagonist} descends from darkness, armored in something that flickers between flesh and shadow, their {SoP} alive with storming power.");
            ...
            Console.WriteLine($"The sky splits open. Power erupts. {protagonist}'s {SoP} and {antagonist}'s {SoP} clash in a storm of raw force. {friend1} joins the fight.\n{friend2} crawls forward, torn, unsure. The world around burns bright, flashing.");
            
            PauseAndClear();
            
            Console.WriteLine($"The ground shakes. The wind howls like it's mourning the world. Blackspire cracks at its foundation as {protagonist} and {antagonist} face each other in the heart of the collapsing fortress.\nThe floor beneath them glows red. Magma veins split through stone.");
            ...
            Console.WriteLine($"The pulse syncs with the {SoP} in {protagonist}'s hand. Every heartbeat is pain.\nEvery breath, fire. {protagonist} is bleeding from the last fight, but still rises.");
            ...
            Console.WriteLine($"{protagonist}'s {SoP} clashes with theirs in a white-hot explosion. The shockwave shatters the walls. Dust and flame rain down. They both fly back and land hard-\nbones cracking, blood spattering on the floor.");
            ...
            Console.WriteLine($"They fight like animals. No grace. No rhythm. Just fury. Steel, fire, fists, and teeth. {protagonist}'s {SoP} bends under the weight of the clash, singing like it's screaming with them.");
            
            PauseAndClear();
            
            Console.WriteLine($"{antagonist} grabs {protagonist}'s neck and slams them into the ground. Leaving their vision swimming.");
            ...
            Console.WriteLine($"With a roar, {protagonist} twists free and drives their {SoP} through {antagonist}'s side. Blood sprays-\nthick and black. {antagonist} howls. Their {SoP} pulses violently, unstable.");
...

        {
            ...
            Console.WriteLine($"Both of their {SoP}s ignite like twin suns. The energy swells...unstoppable, chaotic. It burns {protagonist}'s hands. Cracks their skin. They feel blood leaking from their eyes.\nTeeth loosen. Something inside breaks, but they do not stop.");

            PauseAndClear();
            
            Console.WriteLine($"{protagonist} pushes harder. One final swing...{SoP} meeting {SoP}.\nReality fractures.");
            
            PauseAndClear();
            
            Console.WriteLine($"The shockwave is cataclysmic. Stone turns to ash. The ceiling gives. A scream is swallowed by all the collapsing fortress as fire consumes it all.");
        ...
        static void Chapter6_Epilogue1(string protagonist, string antagonist, string friend1, string friend2, string SoP)

        {
            ...
            Console.WriteLine($"The sky is ash-colored. The air is too still. {protagonist} lies on their back, coughing, their body broken in places they can't name, half-buried in the scorched earth.\nThe {SoP} - what's left of it - lies cracked beside them, faintly glowing.");
            ...
            Console.WriteLine($"{protagonist} slowly reaches out. Taking {friend2}'s hand. Pulling them up. Not all the way -\nbut enough to say,\n'' You're still one of us. ''");
            
            PauseAndClear();
            
            Console.WriteLine($"Three survivors.\nOne broken {SoP}.\nOne dead god...\nAnd a world still waiting to burn.");
...

        {
            ...
            Console.WriteLine($"A heartbeat.\nSlow. Wet. Heavy.\nThen another.\nBeneath the ruins of Blackspire...\nsomething still breathes.");
            
            PauseAndClear();
            
            Console.WriteLine($"The floor is littered with broken stone and scorched bone. A ritual circle, long dormant, flickers back to life -\npowered by blood soaked into the stone. In its center lies a shattered figure. Barely recognizable.");
            ...
            Console.WriteLine($"They crawl from the circle. Blood smears across the ground. One arm is limp. Part of their face is missing - but they smile anyway.");
        ...
        {
            Console.WriteLine($"Welcome back, {username}! This was an great collaboration. I did promise a cookie but I have seem to run out of them completely.");
            
            PauseAndClear();
            
            Console.WriteLine($"I got a little carried away with the bag throughout this journey together. I owe you one. I do hope you enjoyed this journey as much as I did.");
            ...
            Console.WriteLine($"Okay. Well, I guess since you are still sticking around...\nDid you enjoy the journey so far?");

            Console.ReadLine();
            
            ClearScreen();

            Console.WriteLine($"It may have not been for everyone, but I do appreciate the feedback. You obviously know a sequel will be coming.\nAnd no I do not know the date of when so if you are interested. \nYou know...I guess I owe you two cookies for keeping me company then.\nLater!");
            
            PauseAndClear();
            
            Console.WriteLine($"Damn, {username}. You are the persistent one. I would tell you to fuck off by now, but I do admire the determination to see what happens at the end.");
